...
export const Inscription = () => {
    ...
    InscriptionSubmit.addEventListener("submit", (e) => {
        ...
        let test = (nom !== "" && prenom !== "" && email !== "" && password.value !== "") ? true : false
        ...
        if (!test) {
            ...
            table.push({ id, nom, prenom, email, password: password.value })
        ...
        if (!test) { n
            ...
            if (table && table.length > 0) {
                ...
                if (testUser !== undefined) {
                    ...
                    location.href = "/profil.html" //On redirige l'utilisateur vers la page profil.html lorsque la connexion est reussi
                } else {
                    setTimeout(() => {
